...
public class EtkinlikGuncelleDto {
    ...
    public EtkinlikGuncelleDto(Long etkinlikId,SalonEntity salon,List<SeansDuzenleDto> seansDuzenleDtoList, EtkinlikTurEntity etkinlikTur, SehirEntity sehir, String etkinlikAdi, String kapakFotografi, String etkinlikAciklamasi, int yasSiniri, Timestamp etkinlikSuresi, float biletFiyati) {
